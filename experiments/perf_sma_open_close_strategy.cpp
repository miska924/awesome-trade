...
using TCacheNaiveStrat = TStrategy<TCrossOpener<TCachedFeature<TNaiveSmaFeature>>, TCrossCloser<TCachedFeature<TNaiveSmaFeature>>>;
using TCacheSmartStrat = TStrategy<TCrossOpener<TCachedFeature<TSmaFeature<2>>>, TCrossCloser<TCachedFeature<TSmaFeature<2>>>>;
...
int main() {
    ...
    {
        uint64_t t = Duration(candles, TCacheNaiveStrat(params));
        std::cout << "CacheNaive: " << t << "ms" << std::endl;
    }
    {
        uint64_t t = Duration(candles, TCacheSmartStrat(params));
        std::cout << "CacheSmart: " << t << "ms" << std::endl;
    }
}